        ...
        for (int i = 0; i < BOARD_SIZE; i++)
            for (int j = 0; j < BOARD_SIZE; j++) {
                ...
                switch (game.board[i][j]) {
                    case EMPTY_CELL: renderTexture(cellEmpty, x+120, y+40); break;
                    case X_CELL: renderTexture(cellX, x+120, y+40); break;
                    case O_CELL: renderTexture(cellO, x+120, y+40); break;
                };
            };
